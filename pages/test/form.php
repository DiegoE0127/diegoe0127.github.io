        ...
        <form action="form.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group text-center" style="position: relative;" >
            <span class="img-div">
              ...
              <img src="pfp/avatar.png" onClick="triggerClick()" id="profileDisplay">
            </span>
          ...
          <div class="form-group">
            ...
            <button type="submit" name="show_profile" class="btn btn-primary btn-block-show">Show User</button>
          </div>
        </form>
      </div>
    </div>
